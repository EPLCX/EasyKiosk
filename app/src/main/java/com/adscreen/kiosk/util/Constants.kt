...
object Constants {
    ...
    const val ROOT_CMD_RESTORE_NAV_BAR = "settings put global policy_control \"\""
    const val ROOT_CMD_DELETE_POLICY_CONTROL = "settings delete global policy_control"
    ...
    const val ROOT_CMD_ENABLE_SYSTEMUI = "pm enable com.android.systemui"
